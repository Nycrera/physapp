...
app.post('/registerUser',admin_auth, express.urlencoded(), require('./controllers/register')[1]);
app.get('/editUser', admin_auth, require('./controllers/editUser')[0]);
app.post('/editUser', admin_auth, express.urlencoded(), require('./controllers/editUser')[1]);
...
app.post('/admin_login', express.urlencoded(), require("./controllers/adminLogin")[1]);
app.get('/admin_login', require("./controllers/adminLogin")[0]);

app.post('/login', express.urlencoded(), require("./controllers/login")[1]);
